---
title: Infrastructure as Code, but actually
template: splash
sidebar:
  order: 1
hero:
  image:
    file: ../../assets/yoke.v2.webp
  # actions:
  #   - text: Example Guide
  #     link: /guides/example/
  #     icon: right-arrow
...
# Introducing the Infrastructure as Code Package Manager for Kubernetes
...
With yoke, **Flights are programs that generate the desired Kubernetes resources in either JSON or YAML format and output them to stdout**. Flights are typically packaged as **[WebAssembly (wasm) executables](/docs/pages/concepts.html#why-wasm)**, with Yoke embedding Wazero, a zero-dependency wasm runtime for Go, to execute these programs.
