...
<Code
  lang="go"
  code={await fetch('<https://raw.githubusercontent.com/yokecd/examples/refs/heads/main/atc/backend/v1/backend.go').then(>
    resp => resp.text()
  )}
  title="backend.go"
/>
...
<Code
  lang="go"
  code={await fetch(
    '<https://raw.githubusercontent.com/yokecd/examples/refs/heads/main/atc/backend/v1/flight/main.go>'
  ).then(resp => resp.text())}
  title="flight/main.go"
/>
...
<Code
  lang="go"
  code={await fetch(
    '<https://raw.githubusercontent.com/yokecd/examples/refs/heads/main/atc/backend/airway/main.go>'
  ).then(resp => resp.text())}
  title="airway/main.go"
/>
